!function (t, e) {
                ...
                t.each(this.split(","), function (r, i) {
                    if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(d + "-corner-right"), o = null; else {
                        ...
                        if (e[i] ? s = e[i] : me[i] && (s = function () {
                            ...
                            var l = n.theme ? Y(n.buttonIcons, i) : null, c = Y(n.buttonText, i),
    ...
    function Z(e, n, r) {
        ...
        var L, _, Y, j, I, X, J, V, U, Z, $, Q, K, te, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be = O.opt,
            we = O.trigger, Ce = O.renderOverlay, Me = O.clearOverlays, Te = O.daySelectionMousedown, Ee = O.cellToDate,
    ...
    function K(n, r, a) {
        ...
        var K, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be, we, Ce, Me, Te, Ee, Se, xe, ke, He, Fe, Re, Ne, ze,
            We, Ae, Oe, Le, _e, Ye, qe, Be, Pe, je, Ie, Xe, Je, Ve, Ue, Ze = Q.opt, Ge = Q.trigger,
    ...
    function te() {
        ...
        var y = m.opt, b = m.trigger, D = m.isEventDraggable, w = m.isEventResizable, M = m.eventEnd,
            E = m.eventElementHandlers, k = m.setHeight, H = m.getDaySegmentContainer, F = m.getSlotSegmentContainer,
            N = m.getHoverListener, z = m.getMaxMinute, W = m.getMinMinute, A = m.timePosition, O = m.getIsCellAllDay,
            L = m.colContentLeft, _ = m.colContentRight, Y = m.cellToDate, B = m.segmentCompare, P = m.getColCnt,
    ...
    function oe() {
        ...
        var S = E.opt, k = E.trigger, H = E.isEventDraggable, F = E.isEventResizable, R = E.eventEnd,
            N = E.reportEventElement, z = E.eventElementHandlers, W = E.showEvents, A = E.hideEvents, O = E.eventDrop,
            _ = E.eventResize, Y = E.getRowCnt, P = E.getColCnt, I = (E.getColWidth, E.allDayRow), X = E.colLeft,
            J = E.colRight, V = E.colContentLeft, U = E.colContentRight, Z = (E.dateToCell, E.getDaySegmentContainer),
            G = E.calendar.formatDates, $ = E.renderDayOverlay, Q = E.clearOverlays, K = E.clearSelection,
            te = E.getHoverListener, ee = E.rangeToSegments, ne = E.segmentCompare, re = E.cellToDate,
            ae = E.cellToCellOffset, oe = E.cellOffsetToDayOffset, le = E.dateToDayOffset, ce = E.dayOffsetToCellOffset
    }
